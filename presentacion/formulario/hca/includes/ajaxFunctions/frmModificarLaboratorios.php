...
//PREREQUISITOS
if(!$base->hayLaboratoriosSinHacer($idHCA)) //tiene que tener algun laboratorio sin hacer
{
	$error = true;
...
if(!$error)
{
	...
	if($error)
	{
		$message = "No se pueden agregar laboratorios si ya existe la salida";
	}
}
...
{ 
?>
	<form action="agregarLaboratorios.php" id="formDatos">
	<div id="divPrincipal" title="Agregar Laboratorios" style="width: 600px; margin: 0 auto 0 auto">
		...
		<?php
			...
			$laboratorios = $base->laboratoriosSinHacer($idHCA, $tipo); 
