...
$error = false;
$message = "";
$interconsultas = $base->interconsultas($idHCA);
if(count($interconsultas)>=5)
{
	$error = true;
	$message = "Tiene un limite de 5 interconsultas para agregar";
}
if(!$error)
{
	...
	if($error)
	{
		$message = "No se pueden agregar interconsultas si ya existe la salida";
	}
}
...
?>
	...
	<div id="divPrincipal" title="Agregar Pendiente" style="width: 550px; margin: 0 auto 0 auto">
		...
		<div id="divInterconsultas" style="clear: both;">
