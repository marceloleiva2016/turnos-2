...
$message = "No tiene permiso para eliminar la/el $item";
...
{
?>
	<form action="eliminarObservacion.php" id="formDatos">
	<div id="divPrincipal" title="Eliminar <?php echo $mayuscula;?>" style="width: 550px; margin: 0 auto 0 auto">
		
		<div id="divObservaciones" style="clear: both;">
		Esta seguro que desea eliminar la/el <?php echo $item?>: </br>
		<p><b>
		<?php echo Utils::phpStringToHTML($observacion->descripcion);?>
		</b>		
		</p>
