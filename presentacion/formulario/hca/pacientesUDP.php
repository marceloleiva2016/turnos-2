...
if($error) {
	header('Location: pacientesUDPForm.php');
...
<title>Pacientes UDP</title>
   ...
   <!--  <link type="text/css" rel="Stylesheet" href="/tools/jquery/css/ui-lightness/jquery-ui-1.8.11.custom.css" />--> 
	...
	<script src="includes/js/pacientesUDP.js" type="text/javascript"></script>
...
<div id="barra" >
	...
	<div style="float: left;">
		...
		<a href="pacientesUDPForm.php">Lista Pacientes UDP</a></p>
	</div>
			...
			<tr>
   			 <td> 
   			 	<div id="barral" style="clear:both; height:100px;vertical-align:middle;background-color:#A4BCDF; color: white;">
   			 		<br />
   			 		<h2 align="center">Pacientes UDP<br /> </h2>
    			...
    			<div id="cargando" style="position:relative; left:80px; top:100px; display:none; color: blue;" align="center">
             	...
             	<div id="contenido" align="center">
                	...
                	<a target="_blank" href="includes/ajaxFunctions/excelPacientesUDP.php">Excel</a>
                	</div>
...
<form action="formularioUDP.php" method="post" id="frmSeleccionarPaciente" target="_blank" >
