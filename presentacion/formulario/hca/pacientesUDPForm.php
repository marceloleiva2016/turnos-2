...
<title>Listado pacientes UDP</title>
    	...
    	<table id="tablaInt" width="100%">
			<tr>
   			 <td>     
             	...
             	<h2 align="center">LISTADO PACIENTES <br />UDP</h2>
             		<div id="error">
             		<?php
             		...
             		<div id="login" style="background: #97BB95; width: 500px; height: 300px;-moz-border-radius: 10px;background-image:url(./includes/images/Quirofano4.png)">
   			 			<form method="post" action="pacientesUDP.php" style="position:relative; margin: 10px; width: 450px; top:70px">
                    	<p>
